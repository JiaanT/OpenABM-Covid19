...
typedef struct{
	...
	int self_quarantine_household_on_symptoms;   	   // HealthCode: self-quarantine other household members when someone shows symptoms
	int self_quarantine_household_on_positive;   	   // HealthCode: self-quarantine other household members when someone tests positive
	int centralized_quarantine_household_on_positive;   	   // HealthCode: centrlized-quarantine other household members when someone tests positive
	int self_quarantine_household_on_traced_symptoms;   // HealthCode: self-quarantine other household members when someone is contact traced and index has symptoms
	int self_quarantine_household_on_traced_positive;   // HealthCode: self-quarantine other household members when someone is contact traced and index is positive
	int centralized_quarantine_household_on_traced_positive;   // HealthCode: centralized-quarantine other household members when someone is contact traced and index is positive
	int self_quarantine_household_contacts_on_positive; // HealthCode: self-quarantine the contacts of other household members when someone tests positive
	int centralized_quarantine_household_contacts_on_positive; // HealthCode: centralized-quarantine the contacts of other household members when someone tests positive
...
int get_model_param_health_code_system_on(model *pmodel);
...
int set_model_param_health_code_system_on(model *pmodel, int value);
