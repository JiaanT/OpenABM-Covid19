...
void set_up_ward_networks( ward* ward, int max_hcw_daily_interactions )
{
    ...
    ward->doctor_patient_network = create_network( ward->n_worker[DOCTOR], interaction_type );
    ...
    ward->doctor_patient_network->skip_self_quarantined  = TRUE;
    ward->doctor_patient_network->skip_centralized_quarantined  = TRUE;
    ...
    ward->nurse_patient_network = create_network( ward->n_worker[NURSE], interaction_type );
    ...
    ward->nurse_patient_network->skip_self_quarantined  = TRUE;
    ward->nurse_patient_network->skip_centralized_quarantined  = TRUE;
